...
Authority: none
Default-read: no
Historical-scope: Historical validation evidence / phase-validation record (AG93C_OFFLINE_REPLAY_REVIEW_PACKET).
...
- `docs/history/validation/AG93C_OFFLINE_REPLAY_REVIEW_PACKET.md`
