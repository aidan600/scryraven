...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG75A_CONTROLLER_PROVIDER_SEARCH_ALLOCATION_GATE).
...
- `docs/history/architecture/phases/AG74F_RECOVERY_RUNNER_EXTRACTION.md`
