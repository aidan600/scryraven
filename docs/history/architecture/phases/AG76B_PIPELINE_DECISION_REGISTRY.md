...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG76B_PIPELINE_DECISION_REGISTRY).
...
- `docs/history/architecture/phases/AG75C_LOCAL_AUTHORITY_GATE_RETIREMENT_AUDIT.md` exists.
