...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG74F_RECOVERY_RUNNER_EXTRACTION).
...
- `docs/history/architecture/phases/AG74E_RECOVERY_EXECUTOR_ORCHESTRATOR_PLUMBING_CHECKPOINT.md`
- `docs/history/architecture/phases/AG74D_CONTROLLER_RECOVERY_RETRY_STOP_LOOP.md`
