...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (CONTROLLER_STATE_MAP_AG23).
...
- `docs/history/validation/AG22_OFFICIAL_SOURCE_DOMAIN_RECOVERY_LIVE_VALIDATION.md`
