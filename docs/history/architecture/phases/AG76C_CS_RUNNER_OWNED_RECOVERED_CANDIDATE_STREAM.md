...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG76C_CS_RUNNER_OWNED_RECOVERED_CANDIDATE_STREAM).
...
- `docs/history/architecture/phases/AG75C_LOCAL_AUTHORITY_GATE_RETIREMENT_AUDIT.md`
