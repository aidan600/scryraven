...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG76D_BD_CONTROLLER_AUTHORITY_TRANSFER_BURNDOWN).
...
- `docs/history/architecture/phases/AG76D_FU_FOLLOWUP_AS_CONTROLLER_INITIAL_STATE.md`;
