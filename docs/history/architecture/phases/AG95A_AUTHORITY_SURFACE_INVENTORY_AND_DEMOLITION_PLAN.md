...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG95A_AUTHORITY_SURFACE_INVENTORY_AND_DEMOLITION_PLAN).
...
Use `docs/history/architecture/phases/AG95N_O_P_FINAL_AUTHORITY_VISIBILITY_RECOVERY_DECISION_PROJECTION_BURNDOWN.md`
