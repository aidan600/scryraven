...
Authority: none
Default-read: no
Historical-scope: Historical architecture phase/proof record (AG76C_BD_ORCHESTRATOR_BURN_DOWN_REVIEW).
...
> `docs/history/architecture/phases/AG76C_BD_R2_POST_RT_OP_PE_BURNDOWN.md` and
...
- `docs/history/architecture/phases/AG76C_DP_DIAGNOSTICS_PROJECTION_HANDOFF_EXTRACTION.md`
...
- `docs/history/architecture/phases/AG76C_CS_RUNNER_OWNED_RECOVERED_CANDIDATE_STREAM.md`
...
- `docs/history/architecture/phases/AG76C_FE_FINAL_EVIDENCE_BUNDLE_EXTRACTION.md`
- `core/final_evidence_bundle_builder.py`

AG-76B registry artifacts were present:

- `docs/history/architecture/phases/AG76B_PIPELINE_DECISION_REGISTRY.md`
- `core/pipeline_decision_registry.py`
