...
every post-READ action except exact semantic handoff and factual binding. The
model may author a bounded query only for `PROPOSE_FOLLOWUP_QUERY`; QueryPlan
