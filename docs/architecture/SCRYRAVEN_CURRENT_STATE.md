...
| READ | yes | yes | separate subordinate SearchJudgment establishes current need per active slot; exact nomination reaches main-RunKernel Linkup Fetch/Tavily Extract and canonical custody |
