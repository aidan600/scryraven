...
Status: retained v1 Cursor workflow reference; non-authoritative for current work.
...
This document does not replace AGENTS.md, docs/codex/CODEX_GUIDANCE_MAP.md, or docs/codex/ARCHITECTURE_GROOVE_PLAYBOOK.md. It adds Cursor-specific workflow and command hygiene expectations.
...
3. Read AGENTS.md and docs/codex/CODEX_GUIDANCE_MAP.md.
