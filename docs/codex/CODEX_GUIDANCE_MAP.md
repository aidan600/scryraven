...
| Post-analysis recovery, append-only recovery cycles, Analyst-derived components, stopping convergence, recovery generation depth, unified inference direction, and legacy recovery convergence (`canonical:searchos-post-analysis-recovery-and-inference-direction`) | [SearchOS Post-Analysis Recovery And Inference Direction](../architecture/SEARCHOS_POST_ANALYSIS_RECOVERY_AND_INFERENCE_DIRECTION.md) |
