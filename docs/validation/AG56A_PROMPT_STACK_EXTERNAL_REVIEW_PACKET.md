...
- `docs/validation/AG51C_CANONICAL_TECHNICAL_DOCUMENTATION_PROMPT_QUERY_POLICY_REPAIR.md`
- `docs/validation/AG51D_POST_POLICY_CANONICAL_TECH_DOCS_LIVE_CLASSIFICATION.md`
- `docs/validation/AG51A_EXISTING_PROVIDER_OFFICIAL_CANONICAL_RECOVERY_ACQUISITION_STRATEGY.md`
- `docs/validation/AG52B_OFFICIAL_CANONICAL_RECOVERY_CANDIDATE_VISIBILITY_CLASSIFICATION.md`
- `docs/validation/AG52A_OFFICIAL_CANONICAL_RECOVERY_EVIDENCE_ACCEPTANCE_SOURCE_FIT.md`
