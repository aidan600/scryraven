...
ROLE_SYSTEM_PROMPTS = {
    ROLE_COMPONENT_ANALYST: (
        ...
        "component evidence and its quantitative_source_catalog. Return one JSON "
        "object with claim_text, support_status, caveats, nonclaims, and blockers. "
        "When this exact component claim materially depends on a supported "
        "deterministic calculation, you may add one specialist_need_proposal for "
        "source_bound_quantitative_calculation using only source_local_key "
        "component_evidence and exact supplied source_numeric_literal text. Include "
    ...
    ROLE_CROSS_COMPONENT_ANALYST: (
        ...
        "nonessential precision or explanation. Do not validate or admit your "
