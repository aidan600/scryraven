...
ROLE_SYSTEM_PROMPTS = {
    ROLE_COMPONENT_ANALYST: (
        ...
        "warrant as a string; self_audit as a string; and caveats, nonclaims, "
        "contradictions, and blockers as arrays of strings. Optional uncertainty, "
        "confidence, missing_evidentiary_premise, unresolved_need, and "
        "calculation_need values must be strings. Omit optional fields and proposal "
        "namespaces when unused; do not return them as null, empty objects, or "
        "invented schema wrappers. case_posture must be exactly supported, "
        ...
        "Do not propose a calculation merely to restate a literal already explicit "
        "in the bounded evidence; evaluate that source-stated literal directly. "
