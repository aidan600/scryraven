...
def build_run_outcome_from_scope(runtime_values: Mapping[str, Any]) -> Any:
    ...
    return build_run_outcome(
        ...
        pipeline_config=v["pipeline_config_payload"], terminal_status=v["run_outcome_terminal_status"],
        kb_instrumentation=v["kb_instrumentation"], kb_warning=v["kb_warning"],
